<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\MrF\FyNavigation\public/../application/admin\view\links\edit.html";i:1586536904;}*/ ?>
<!DOCTYPE html>
                            ...
                            <form class="layui-form">
                              <div class="layui-form-item">
                                  ...
                                  <div class="layui-input-inline">
                                      <input type="text" name="link_icon" lay-verify="required" id="inputimgurl" placeholder="图片地址" value="<?php echo $data['link_icon']; ?>" class="layui-input">
                                  </div>
                              </div>
                              <div class="layui-form-item">
                                 <label class="layui-form-label">图标预览</label>
                                  <div class="layui-input-inline">
                                      <div class="layui-upload-list" style="margin:0">
                                          <img src="<?php echo $data['link_icon']; ?>" id="srcimgurl" class="layui-upload-img">
                                      </div>
                                  </div>
                              </div>
                              <div class="layui-form-item">
                              ...
                              <div class="layui-form-item">
                                  ...
                                  <div class="layui-input-inline">
                                      ...
                                      autocomplete="off" value="<?php echo $data['link_name']; ?>" class="layui-input">
                                  </div>
                              ...
                              <div class="layui-form-item">
                                  ...
                                  <div class="layui-input-inline">
                                      <input type="text" id="link_address" name="link_address" required="" lay-verify="link_address" value="<?php echo $data['link_address']; ?>"
                              ...
                              <div class="layui-form-item">
                                  ...
                                  <div class="layui-input-inline">
                                      <select id="mt_id" name="mt_id" class="valid">
                                          ...
                                          <option value="<?php echo $m['id']; ?>" <?php echo $data['mt_id']==$m['id']?'selected':''; ?>><?php echo $m['type_name']; ?></option>
                                          <?php endforeach; ?>
                                      </select>
                                  </div>
                                  <div class="layui-form-mid layui-word-aux">
                              ...
                              <div class="layui-form-item">
                                  ...
                                  <div class="layui-input-inline">
                                      ...
                                      autocomplete="off" value="<?php echo $data['link_note']; ?>" class="layui-input">
                                  </div>
                                  <div class="layui-form-mid layui-word-aux">
                              ...
                              <div class="layui-form-item">
                                  ...
                                  <div class="layui-input-inline">
                                      <input type="number" id="link_order" name="link_order" required="" lay-verify="link_order" value="<?php echo $data['link_order']; ?>" 
                                      autocomplete="off" class="layui-input">
                                  </div>
                                  <div class="layui-form-mid layui-word-aux">
          ...
          layui.config({
            ...
            function() {
                ...
                form.on('submit(add)', function(data) {
                    ...
                    $.post('/admin/links/<?php echo $data["id"]; ?>.html', data.field, function(data, textStatus, xhr) {
                      if (data.code == 1) {
                          // 定时器
                          setTimeout(function() {
