    ...
    <nav class="navbar horizontal-menu navbar-fixed-top">
        <div class="navbar-inner">
            <div class="navbar-brand">
                <a href="/" class="logo">
                    <img src="<?php echo $info['logo']; ?>" width="200" alt="" class="hidden-xs">
                    <img src="<?php echo $info['logo']; ?>" width="100%" alt="" class="visible-xs">
                </a>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <blockquote>
                                        ...
                                        <p>如果你也是技术爱好者，如果你也正好喜欢设计，那希望这个网站能给你带来一些作用。</p>
                                        <p>有任何建议都可以给我发邮件交流，邮箱：<strong>admin@fyovo.com</strong>  </p>
                                    </blockquote>
                                </div>
                            </div>
                            <!-- 关于站长 -->
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="xe-widget xe-conversations box2 label-info" onclick="window.open('https://www.fyovo.com/', '_blank')" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="https://www.fyovo.com/">
                                        <div class="xe-comment-entry">
                                            <a class="xe-user-img">
                                                <img src="/static/index/assets/images/logo-collapsed@2x.png" class="img-circle" width="40">
                                            </a>
                                            <div class="xe-comment">
                                                <a href="#" class="xe-user-name overflowClip_1">
                                                    <strong>风影OvO</strong>
                                                </a>
                                                <p class="overflowClip_2"> 本站前端开发 by Viggo. <br>本站后台开发 by 风影OvO.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
