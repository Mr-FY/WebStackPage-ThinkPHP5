<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\MrF\FyNavigation\public/../application/admin\view\links\index.html";i:1586535068;}*/ ?>
<!DOCTYPE html>
                            ...
                            <table class="layui-table layui-form">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <a href="<?php echo $li['link_address']; ?>" target="_blank"><?php echo $li['link_address']; ?></a>
                                  </td>
                                  <td>
                                    <img src="<?php echo $li['link_icon']; ?>" width="30" height="30">
                                  </td>
                                  <td><?php echo $li['link_note']; ?></td>
                                  <td><?php echo $li['type_name']; ?></td>
                                  <td><?php echo $li['link_order']; ?></td>
                                  <td class="td-status">
                                  ...
                                  <td class="td-manage">
                                    <a title="编辑"  onclick="xadmin.open('编辑','/admin/links/<?php echo $li["id"]; ?>/edit.html',1000,800)" href="javascript:;">
